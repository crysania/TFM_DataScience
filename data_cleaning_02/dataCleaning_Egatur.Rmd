...
En este script se realiza la integración de datos, se enfoca a la combinación de múltiples ficheros de registros para crear nuevos, uniendo datos sobre un mismo objeto que se encuentran dispersos en diferentes fuentes.

Además se produce la selección de datos, es decir, la decisión sobre los datos a emplear en el análisis, usando criterios relativos a la relevancia para los objetivos, la calidad de los datos o restricciones técnicas. 

Esta selección a realizar se refiere tanto a los atributos o campos de los registros de los ficheros, como a los registros en sí.

A continuación se realiza la limpieza de datos, que consiste en “elevar” el nivel de calidad de los datos al requerido por las técnicas de análisis. 
...
Los ficheros que se van a limpiar en este script son los relacionados con “Encuesta de gasto turístico. Egatu
