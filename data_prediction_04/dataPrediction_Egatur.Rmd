...
Existen difencias entre los grupos obtenidos según el número de Clusters, si se quiere realizar un análisis más detallado de cada perfil de turistas se necesita un mayor grado de clusterización.
