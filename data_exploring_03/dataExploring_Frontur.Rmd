...
Se obtiene el número de turistas internacionales por meses, variación temporal Octubre 2015 a Abril 2017, Destino_CCAA y País.

De los datos se obtiene que el mes de Agosto de 2016 hubo la mayor cantidad de viajeros franceses que utilizaron España como país de Tránsito, pero también son los franceses en este mismo mes y año que eligieron Cataluña como destino turístico Español.


```{r Bloque el número de turistas internacionales por meses, Pais y Destino_CCAA }

Ft_dt3 <- Ft_dt[, list(Viajeros = sum(Viajeros)), by = c("Anyo","Mes", "Destino_CCAA", "Pais")]
...
Por el contrario en Agosto del 2016, fue el periodo menos visitado eligiendo Cantabria como destino.
