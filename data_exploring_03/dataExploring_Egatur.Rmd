...
El fichero PaisesE.csv se relacionan los códigos de cada país, con el nombre del País de resisdencia habitual del turista.

El fichero CCAAE.csv contiene los códigos de las CCAA y su nombre correspondiente como destino principial del viaje.
...
egaturRFM <- dsEgatur[c(1,10,12,13)]

head(egaturRFM)

```

Los turistas que vienen a España durante el periodo Abril 2016 a Marzo 2017 se gastan 111.760.512.068 euros.
...
En Abril del 2016 se ha dectectado que el gasto más bajo lo realizaron los portugueses --> 48.219.280 euros
